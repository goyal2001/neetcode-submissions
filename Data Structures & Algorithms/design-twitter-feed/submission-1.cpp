...
public:
    ...
    int timer;
     ...
     void insertTopTweetInHeap (int user, priority_queue<pair< int, pair<int,int>> > &pq) {
    ...
    vector<int> getNewsFeed(int userId) {
        ...
        insertTopTweetInHeap(userId, pq);

        for (int follower: followReq[userId])  insertTopTweetInHeap(follower, pq);
